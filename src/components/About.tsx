...
// ⚡ Bolt Optimization: Extracted inline hover states to module-level constants
// to prevent object reallocation on every render inside the mapped details array.
...
const detailArrowHoverState = { x: 5 };
